      ...
      child: Column(
        ...
        children: [
          ScaleTransition(
            ...
            //     Color(0xFF35B1B7) : null
            // ,width: 30,),
            IconButton(icon: Icon(Icons.home,color:widget.activeIndex == widget.index ?
             Color(0xFF35B1B7) : null),onPressed: null,)
          ),
          // Spacer(),
          Text(
            widget.icon['title'],
            style: TextStyle(
                color:
                widget.activeIndex == widget.index ? Color(0xFF35B1B7) : null),
          ),
        ],
      ),
    );
